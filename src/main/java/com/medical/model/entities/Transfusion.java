...
@NamedQueries({
    ...
    @NamedQuery(name = "Transfusion.findByDonorId", query = "SELECT t FROM Transfusion t WHERE t.transfusionPK.donorId = :donorId"),
    @NamedQuery(name = "Transfusion.findByReceiverId", query = "SELECT t FROM Transfusion t WHERE t.transfusionPK.receiverId = :receiverId")})
public class Transfusion implements Serializable {
    ...
    public String toString() {
        return "com.medical.model.entities.Transfusion[ transfusionPK=" + transfusionPK + " ]";
    }
